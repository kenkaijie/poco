 ...
 * 
 * Uses some Zephyr related primitives for time keeping and 
 *
 * Has many shortcuts.
 */
 ...
 int platform_swap_context(platform_context_t *current_context, const platform_context_t *new_context);
